...
final class SajuResultAccuracyTests: XCTestCase {
    ...
    func test_localization_allKeysPresent_inKoLProj() {
        let keys = [
            ...
            "saju.result.origin.subtitle",
            "saju.result.origin.me",
            "saju.result.origin.strong",
            "saju.result.origin.supplement",
            "saju.result.origin.investmentStyle",
            "saju.result.column.yearPillar",
            "saju.result.column.monthPillar",
            "saju.result.column.dayPillar",
            "saju.result.column.hourPillar",
